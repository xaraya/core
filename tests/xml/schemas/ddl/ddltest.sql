CREATE TABLE _block_group_instances (id INTEGER  NOT NULL  , group_id INTEGER  NOT NULL DEFAULT '0' , instance_id INTEGER  NOT NULL DEFAULT '0' , template VARCHAR(100)    , position INTEGER  NOT NULL DEFAULT '0' , PRIMARY KEY (id));
CREATE TABLE _block_groups (id INTEGER  NOT NULL  , name VARCHAR(255)  NOT NULL DEFAULT '' , template VARCHAR(255)  NOT NULL DEFAULT '' , PRIMARY KEY (id));
CREATE TABLE _block_instances (id INTEGER  NOT NULL  , type_id INTEGER  NOT NULL DEFAULT '0' , name VARCHAR(100)  NOT NULL  , title VARCHAR(255)    , content TEXT  NOT NULL  , template VARCHAR(255)    , state INTEGER  NOT NULL DEFAULT '2' , refresh INTEGER  NOT NULL DEFAULT '0' , last_update INTEGER  NOT NULL DEFAULT '0' , PRIMARY KEY (id));
CREATE TABLE _block_types (id INTEGER  NOT NULL  , type VARCHAR(64)  NOT NULL DEFAULT '' , modid INTEGER UNSIGNED NOT NULL DEFAULT '0' , info TEXT    , PRIMARY KEY (id));
CREATE TABLE _cache_blocks (id INTEGER  NOT NULL DEFAULT '0' , nocache INTEGER  NOT NULL DEFAULT '0' , page INTEGER  NOT NULL DEFAULT '0' , user INTEGER  NOT NULL DEFAULT '0' , expire INTEGER    , PRIMARY KEY (id));
CREATE TABLE _dynamic_data (dd_id INTEGER  NOT NULL DEFAULT '0' , dd_propid INTEGER  NOT NULL DEFAULT '0' , dd_itemid INTEGER  NOT NULL DEFAULT '0' , dd_value TEXT    , PRIMARY KEY (dd_id));
CREATE TABLE _dynamic_objects (object_id INTEGER  NOT NULL DEFAULT '0' , object_name VARCHAR(30)  NOT NULL DEFAULT '' , object_label VARCHAR(254)  NOT NULL DEFAULT '' , object_moduleid INTEGER  NOT NULL DEFAULT '0' , object_itemtype INTEGER  NOT NULL DEFAULT '0' , object_parent INTEGER  NOT NULL DEFAULT '0' , object_class VARCHAR(255)  NOT NULL DEFAULT 'DataObject' , object_filepath VARCHAR(255)  NOT NULL DEFAULT 'modules/dynamicdata/class/objects/base.php' , object_urlparam VARCHAR(30)  NOT NULL DEFAULT 'itemid' , object_maxid INTEGER  NOT NULL DEFAULT '0' , object_config TEXT    , object_isalias INTEGER  NOT NULL DEFAULT '1' , PRIMARY KEY (object_id));
CREATE TABLE _dynamic_properties (prop_id INTEGER  NOT NULL DEFAULT '0' , prop_name VARCHAR(30)  NOT NULL DEFAULT '' , prop_label VARCHAR(254)  NOT NULL DEFAULT '' , prop_objectid INTEGER  NOT NULL DEFAULT '0' , prop_type INTEGER  NOT NULL  , prop_default VARCHAR(254)    , prop_source VARCHAR(254)  NOT NULL DEFAULT 'dynamic_data' , prop_status INTEGER  NOT NULL DEFAULT '33' , prop_order INTEGER  NOT NULL DEFAULT '0' , prop_validation TEXT    , PRIMARY KEY (prop_id));
CREATE TABLE _dynamic_properties_def (prop_id INTEGER  NOT NULL DEFAULT '0' , prop_name VARCHAR(254)    , prop_label VARCHAR(254)    , prop_parent VARCHAR(254)    , prop_filepath VARCHAR(254)    , prop_class VARCHAR(254)    , prop_validation VARCHAR(254)    , prop_source VARCHAR(254)    , prop_reqfiles VARCHAR(254)    , prop_modid INTEGER    , prop_args TEXT  NOT NULL  , prop_aliases VARCHAR(254)    , prop_format INTEGER   DEFAULT '0' , PRIMARY KEY (prop_id));
...
CREATE TABLE _module_itemvars (module_var_id INTEGER  NOT NULL  , item_id INTEGER UNSIGNED NOT NULL  , value TEXT    , PRIMARY KEY (module_var_id,item_id));
CREATE TABLE _module_vars (id INTEGER  NOT NULL  , module_id INTEGER    , name VARCHAR(64)  NOT NULL  , value TEXT    , PRIMARY KEY (id));
CREATE TABLE _modules (id INTEGER  NOT NULL  , name VARCHAR(64)  NOT NULL  , regid INTEGER    , directory VARCHAR(64)  NOT NULL  , version VARCHAR(10)  NOT NULL  , class VARCHAR(64)  NOT NULL  , category VARCHAR(64)  NOT NULL  , admin_capable INTEGER  NOT NULL DEFAULT '0' , user_capable INTEGER  NOT NULL DEFAULT '0' , state INTEGER  NOT NULL DEFAULT '1' , PRIMARY KEY (id));
CREATE TABLE _privileges (id INTEGER  NOT NULL DEFAULT '0' , name VARCHAR(100)  NOT NULL DEFAULT '' , realmid INTEGER    , module_id INTEGER    , component VARCHAR(100)  NOT NULL DEFAULT '' , instance VARCHAR(100)  NOT NULL DEFAULT '' , level INTEGER  NOT NULL DEFAULT '0' , description VARCHAR(255)  NOT NULL DEFAULT '' , type INTEGER  NOT NULL DEFAULT '0' , PRIMARY KEY (id));
CREATE TABLE _privmembers (id INTEGER    , parentid INTEGER    );
CREATE TABLE _rolemembers (id INTEGER    , parentid INTEGER    );
CREATE TABLE _roles (id INTEGER  NOT NULL DEFAULT '0' , name VARCHAR(255)  NOT NULL DEFAULT '' , type INTEGER  NOT NULL DEFAULT '0' , users INTEGER  NOT NULL DEFAULT '0' , uname VARCHAR(255)  NOT NULL DEFAULT '' , email VARCHAR(255)  NOT NULL DEFAULT '' , pass VARCHAR(100)  NOT NULL DEFAULT '' , date_reg INTEGER  NOT NULL DEFAULT '0' , valcode VARCHAR(35)  NOT NULL DEFAULT '' , state INTEGER  NOT NULL DEFAULT '3' , auth_modid INTEGER  NOT NULL DEFAULT '0' , PRIMARY KEY (id));
CREATE TABLE _security_acl (partid INTEGER  NOT NULL DEFAULT '0' , permid INTEGER  NOT NULL DEFAULT '0' , PRIMARY KEY (partid,permid));
CREATE TABLE _security_instances (id INTEGER  NOT NULL DEFAULT '0' , module_id INTEGER  NOT NULL DEFAULT '0' , component VARCHAR(100)  NOT NULL DEFAULT '' , header VARCHAR(255)  NOT NULL DEFAULT '' , query VARCHAR(255)  NOT NULL DEFAULT '' , ddlimit INTEGER  NOT NULL DEFAULT '0' , propagate INTEGER  NOT NULL DEFAULT '0' , instancetable2 VARCHAR(100)  NOT NULL DEFAULT '' , instancechildid VARCHAR(100)  NOT NULL DEFAULT '' , instanceparentid VARCHAR(100)  NOT NULL DEFAULT '' , description VARCHAR(255)  NOT NULL DEFAULT '' , PRIMARY KEY (id));
CREATE TABLE _security_realms (id INTEGER  NOT NULL DEFAULT '0' , name VARCHAR(255)  NOT NULL DEFAULT '' , PRIMARY KEY (id));
CREATE TABLE _session_info (id VARCHAR(32)  NOT NULL  , ip_addr VARCHAR(20)  NOT NULL  , first_use INTEGER  NOT NULL DEFAULT '0' , last_use INTEGER  NOT NULL DEFAULT '0' , role_id INTEGER  NOT NULL DEFAULT '0' , vars BLOB    , remember INTEGER   DEFAULT '0' , PRIMARY KEY (id));
CREATE TABLE _template_tags (id INTEGER  NOT NULL  , name VARCHAR(255)  NOT NULL  , module_id INTEGER  NOT NULL DEFAULT '0' , handler VARCHAR(255)  NOT NULL  , data TEXT    , PRIMARY KEY (id));
CREATE TABLE _themes (id INTEGER  NOT NULL  , name VARCHAR(64)  NOT NULL  , regid INTEGER    , directory VARCHAR(64)  NOT NULL  , author VARCHAR(64)  NOT NULL  , homepage VARCHAR(64)  NOT NULL  , email VARCHAR(64)  NOT NULL  , description VARCHAR(255)  NOT NULL  , contactinfo VARCHAR(255)  NOT NULL  , publishdate VARCHAR(32)  NOT NULL  , license VARCHAR(255)  NOT NULL  , version VARCHAR(10)  NOT NULL  , xaraya_version VARCHAR(10)  NOT NULL  , bl_version VARCHAR(10)  NOT NULL  , class INTEGER  NOT NULL DEFAULT '0' , state INTEGER  NOT NULL DEFAULT '1' , PRIMARY KEY (id));
...
CREATE INDEX i__block_group_instances ON _block_group_instances (group_id);
CREATE INDEX i__block_group_instances_2 ON _block_group_instances (instance_id);
CREATE UNIQUE INDEX i__block_groups ON _block_groups (name);
CREATE INDEX i__block_instances ON _block_instances (type_id);
CREATE UNIQUE INDEX i__block_instances_u2 ON _block_instances (name);
CREATE UNIQUE INDEX i__block_types2 ON _block_types (modid,type);
CREATE UNIQUE INDEX i__config_name ON _module_vars (name,module_id);
CREATE INDEX i__dyndata_itemid ON _dynamic_data (dd_itemid);
CREATE INDEX i__dyndata_propid ON _dynamic_data (dd_propid);
CREATE UNIQUE INDEX i__dynobjects_combo ON _dynamic_objects (object_moduleid,object_itemtype);
CREATE UNIQUE INDEX i__dynobjects_name ON _dynamic_objects (object_name);
CREATE INDEX i__dynpropdef_modid ON _dynamic_properties_def (prop_modid);
CREATE UNIQUE INDEX i__dynprops_combo ON _dynamic_properties (prop_objectid,prop_name);
CREATE INDEX i__module_vars_module_id ON _module_vars (module_id);
CREATE INDEX i__module_vars_name ON _module_vars (name);
CREATE INDEX i__privileges_level ON _privileges (level);
CREATE INDEX i__privileges_module ON _privileges (module_id);
CREATE UNIQUE INDEX i__privileges_name ON _privileges (name,module_id,type);
CREATE INDEX i__privileges_realmid ON _privileges (realmid);
CREATE INDEX i__privmembers_parentid ON _privmembers (parentid);
CREATE INDEX i__privmembers_pid ON _privmembers (id);
CREATE INDEX i__rolememb_id ON _rolemembers (id);
CREATE INDEX i__rolememb_parentid ON _rolemembers (parentid);
CREATE INDEX i__roles_email ON _roles (email);
CREATE INDEX i__roles_name ON _roles (name);
CREATE INDEX i__roles_state ON _roles (state);
CREATE INDEX i__roles_type ON _roles (type);
CREATE UNIQUE INDEX i__roles_uname ON _roles (uname);
CREATE INDEX i__security_acl_partid ON _security_acl (partid);
CREATE INDEX i__security_acl_permid ON _security_acl (permid);
CREATE INDEX i__session_last_use ON _session_info (last_use);
CREATE INDEX i__session_role_id ON _session_info (role_id);
