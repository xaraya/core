...
CREATE TABLE xar_dynamic_properties_def (prop_id INTEGER  NOT NULL DEFAULT '0' , prop_name VARCHAR(254)    , prop_label VARCHAR(254)    , prop_parent VARCHAR(254)    , prop_filepath VARCHAR(254)    , prop_class VARCHAR(254)    , prop_validation VARCHAR(254)    , prop_source VARCHAR(254)    , prop_modid INTEGER    , prop_args TEXT  NOT NULL  , prop_aliases VARCHAR(254)    , prop_format INTEGER   DEFAULT '0' , PRIMARY KEY (prop_id));
