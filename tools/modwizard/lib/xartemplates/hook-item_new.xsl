...
<xsl:template match="xaraya_module" mode="xd_hook-item_new">

    <xsl:variable name="table" select="@name" />
    <xsl:message>      * xartemplates/hook-item_new.xd</xsl:message>

<xsl:document href="{$output}/xartemplates/hook-item_new.xd" format="text" omit-xml-declaration="yes" xml:space="preserve">
