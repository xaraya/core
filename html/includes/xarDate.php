...
class xarDate {
    ...
    function getYDay()      { $datearray = getdate($this->timestamp); return $datearray['yday']; }
    ...
    function setTimestamp($x) { $this->timestamp = $x; $this->extract(); }
    ...
    function addYears($x)   { $this->year = $this->year + $x; $this->regenerate(); }
    function addMonths($x)  { $this->month = $this->month + $x; $this->regenerate(); }
    function addDays($x)    { $this->day = $this->day + $x; $this->regenerate(); }
    function addHours($x)   { $this->hour = $this->hour + $x; $this->regenerate(); }
    function addMinutes($x) { $this->minute = $this->minute + $x; $this->regenerate(); }
    function addSeconds($x) { $this->second = $this->second + $x; $this->regenerate(); }
}
