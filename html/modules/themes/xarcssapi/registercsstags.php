...
function themes_cssapi_registercsstags($args)
{
   ...
   // just resetting default tags here, nothing else
    ...
    xarTplRegisterTag( 'themes', 'additional-styles', array(), 'themes_cssapi_styledeliver');
    // Register the tag which is used to include style information
    $cssTagAttributes = array(  new xarTemplateAttribute('file'     , XAR_TPL_REQUIRED | XAR_TPL_STRING),
    ...
    xarTplRegisterTag( 'themes', 'style', $cssTagAttributes ,'themes_cssapi_styletag');
