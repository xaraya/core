...
function dynamicdata_init()
{
    ...
    try {
        ...
        $properties = array(
            ...
            array('moduleid'  ,'Module'             ,$objectid[1],19,'182'         ,$dynamic_objects.'.moduleid'   ,DataPropertyMaster::DD_DISPLAYSTATE_ACTIVE | DataPropertyMaster::DD_INPUTSTATE_ADDMODIFY,5 ,'regid'), // FIXME: change this configuration when we move from regid to systemid
