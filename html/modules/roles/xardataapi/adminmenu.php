...
// TODO: turn this into an xml file
    function roles_dataapi_adminmenu()
    {
        return array(
                ...
                array('mask' => 'EditRole', 'includes' => array('showusers','displayrole','modify','delete','showprivileges','testprivileges'), 'target' => 'showusers', 'title' => xarML('View and edit all groups/users on the system'), 'label' => xarML('Groups &amp; Users')),
