...
*/
    ...
    class MenuBlock extends BasicBlock
    {
        ...
        public $html_content = "http://www.example.com/|Title|Example|";
...
*/
        function display(Array $data=array())
        {
            ...
            if (empty($args['marker'])) $args['marker'] = $this->marker;
            $marker = $args['marker'];
        ...
        //                                    }
            ...
            if (empty($args['displayprint'])) $args['displayprint'] = $this->displayprint;
            if (empty($args['displayrss'])) $args['displayrss'] = $this->displayrss;
            ...
            $data['content'] = array(
                ...
                'where'            => $thismodname,
                'what'             => $thisfuncname,
                'displayrss'       => $args['displayrss'],
                'displayprint'     => $args['displayprint'],
...
*/
        function modify(Array $data=array())
        {
            ...
            if (!isset($data['showlogout'])) $data['showlogout'] = 1;
...
*/
        public function update(Array $data=array())
        {
            ...
            // Global options.
            if (!xarVarFetch('displaymodules', 'str:1', $args['displaymodules'], 'None', XARVAR_NOT_REQUIRED)) return;
            if (!xarVarFetch('modulelist', 'str', $args['modulelist'], '', XARVAR_NOT_REQUIRED)) return;
            if (!xarVarFetch('showlogout', 'checkbox', $args['showlogout'], true, XARVAR_NOT_REQUIRED)) return;
            if (!xarVarFetch('displayrss', 'checkbox', $args['displayrss'], false, XARVAR_NOT_REQUIRED)) return;
            if (!xarVarFetch('displayprint', 'checkbox', $args['displayprint'], false, XARVAR_NOT_REQUIRED)) return;
            if (!xarVarFetch('marker', 'str:1', $args['marker'], '[x]', XARVAR_NOT_REQUIRED)) return;
