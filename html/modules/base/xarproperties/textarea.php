...
class TextAreaProperty extends DataProperty
{
    ...
    function __construct(ObjectDescriptor $descriptor)
    {
        ...
        if(isset($this->args['rows'])) $this->display_rows = $this->args['rows'];
        if(isset($this->args['cols'])) $this->display_columns = $this->args['cols'];
    ...
    public function showInput(Array $data = array())
    {
        ...
        $data['cols']  = !empty($cols) ? $cols : $this->display_columns;
