...
// Mail logger
$systemConfiguration['Log.Mail.Recipient'] = 'xarayalog.txt'; // The recipient that this logger sends emails to
...
// HTML logger
$systemConfiguration['Log.Html.Filename'] = 'xarayalog.txt'; // The name of the logfile of this logger
...
$systemConfiguration['Log.Html.Mode'] = '';              // Integer containing the logfile's permissions mode.
...
$systemConfiguration['Log.Simple.Level'] = '2,4,8,32,64';          // The levels of messages this logger tracks.
...
// SQL logger
$systemConfiguration['Log.Sql.SQLTable'] = 'xarayalog.txt'; // The name of the SQL table of this logger
...
// Syslog logger
$systemConfiguration['Log.Syslog.Facility'] = 'xarayalog.txt'; // The name of the logfile of this logger
