            ...
            case 'update':
                ...
                switch ($data['tab']) {
                    case 'general':
                        ...
                        if (!xarVar::fetch('admin_outgoing', 'id', $admin_outgoing)) {
                            return;
                        }
                        if (!xarVar::fetch('showtemplates', 'checkbox', $showtemplates, false, xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('replyto', 'checkbox', $replyto, false, xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('replytoname', 'str:1:', $replytoname, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('replytoemail', 'str:1:', $replytoemail, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('debugmode', 'checkbox', $debugmode, false, xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        ...
                        if (file_exists(sys::lib() . 'PHPMailer')) {
                            if (!xarVar::fetch('use_external_lib', 'checkbox', $use_external_lib, false, xarVar::NOT_REQUIRED)) {
                                return;
                            }
                    ...
                    case 'incoming':
                        break;
                    case 'outgoing':
                        if (!xarVar::fetch('html', 'checkbox', $html, false, xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('htmluseheadfoot', 'checkbox', $htmluseheadfoot, false, xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('htmlheader', 'str:1:', $htmlheader, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('htmlfooter', 'str:1:', $htmlfooter, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('textuseheadfoot', 'checkbox', $textuseheadfoot, false, xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('textheader', 'str:1:', $textheader, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('textfooter', 'str:1:', $textfooter, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('wordwrap', 'int:1:', $wordwrap, '50')) {
                            return;
                        }
                        if (!xarVar::fetch('priority', 'str:1:', $priority, 'normal')) {
                            return;
                        }
                        if (!xarVar::fetch('encoding', 'str:1:', $encoding)) {
                            return;
                        }
                        if (!xarVar::fetch('embed_images', 'checkbox', $embed_images, false, xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('server', 'str:1:', $server, 'mail')) {
                            return;
                        }
                        if (!xarVar::fetch('smtpHost', 'str:1:', $smtpHost, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('smtpPort', 'int:1:', $smtpPort, '25', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('smtpSecure', 'str:1:', $smtpSecure, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('smtpAuth', 'checkbox', $smtpAuth, false, xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('htmlheader', 'str:1:', $htmlheader, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('smtpUserName', 'str:1:', $smtpUserName, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('smtpPassword', 'str:1:', $smtpPassword, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('sendmailpath', 'str:1:', $sendmailpath, '/usr/sbin/sendmail', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('searchstrings', 'str:1', $searchstrings, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('replacestrings', 'str:1', $replacestrings, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('suppresssending', 'checkbox', $suppresssending, false, xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('redirectsending', 'checkbox', $redirectsending, false, xarVar::NOT_REQUIRED)) {
                            return;
                        }
                        if (!xarVar::fetch('redirectaddress', 'str:1:', $redirectaddress, '', xarVar::NOT_REQUIRED)) {
                            return;
                        }
