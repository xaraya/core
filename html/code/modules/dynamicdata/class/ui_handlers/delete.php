...
class DeleteHandler extends DefaultHandler
{
    ...
    {
        if (!$this->xVar()->get('cancel', $args['cancel'])) {
            return;
        }
        ...
        if (!$this->object->checkAccess('delete')) {
            $msg = $this->xMls()->translate('Delete Itemid #(1) of #(2) is forbidden', $this->args['itemid'], $this->object->label);
        ...
        $title = $this->xMls()->translate('Delete #(1)', $this->object->label);
