...
/**
 * base javascriptapi geteventjs function
 * @extends MethodClass<JavascriptApi>
 */
class GeteventjsMethod extends MethodClass
{
     ...
     * @param mixed $args [type] the type of event trigger; e.g. 'onload', 'onmouseover'
     * @return string an empty string
     * @see JavascriptApi::geteventjs()
     */
