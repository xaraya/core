...
/**
 * base userapi browse_files function
 * @extends MethodClass<UserApi>
 */
class BrowseFilesMethod extends MethodClass
{
                    ...
                    if (is_file($thisfile)) {
                        ...
                        if (!empty($match_glob)) {
                            ...
                            if (strpos($match_glob, '/') === false) {
                                if (@fnmatch($match_glob, $filename) !== true) {
                                    continue;
                                }
                            } else {
                                if (@fnmatch($match_glob, ltrim($thisdir . '/' . $filename, '/')) !== true) {
                                    continue;
                                }
                            }
                        }
                        if (!empty($match_re) && @preg_match($match_preg, ltrim($thisdir . '/' . $filename, '/')) !== true) {
                            continue;
                        }
