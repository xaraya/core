...
*/
    ...
    */
    function includes($mask)
    {
        ...
        if (($p1[2] == null) || (($p1[2] != Privileges_Master::PRIVILEGES_ALL) && ($p1[2]!=$p2[2]))) {
            return false;
        }
    ...
    */
    ...
    {
        $match = Privileges_Master::includes($this->normalform,$mask->normalform);
    ...
    {
        if (strtolower($var) == 'all') $this->module_id = Privileges_Master::PRIVILEGES_ALL;
