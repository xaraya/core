    ...
    public static function xarSecurityCheck($mask,$catch=1,$component='',$instance='',$module='',$rolename='',$realm=0,$level=0)
    {
        ...
        if ($catch && !$pass) {
            if (self::$exceptionredirect && !xarUserIsLoggedIn()) {
                ...
                xarController::$response->redirect(xarModURL(xarModVars::get('roles','defaultauthmodule'),'user','showloginform',array('redirecturl'=> $requrl),false));
            } else {
//                return xarTplModule('privileges','user','errors',array('layout' => 'no_privileges'));
                xarController::$response->redirect(xarModURL('privileges','user','errors',array('layout' => 'no_privileges')));
