...
/**
 * categories userapi leftjoin function
...
class LeftjoinMethod extends MethodClass
{
     ...
     * @param mixed $args ['cidtree'] get items in cid or anywhere below it (= slower than cids, usually)
    ...
    public function __invoke(array $args = [])
    {
        ...
        */
        ...
        $columns = ['category_id','item_id','module_id','itemtype','basecategory'];
        ...
        if (!empty($cidtree)) {
            $cat = $userapi->getcatinfo(['cid' => $cidtree]);
            if (!empty($cat)) {
