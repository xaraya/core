 ...
 */
class BuildTreeMethod extends MethodClass
{
    ...
    public function __invoke(array $args = [])
    {
        ...
        if (isset($data['check'])) {
            ...
            foreach ($all_rows as $key => $row) {
                ...
                if (empty($all_rows[$key][$data['left_id']])) {
                    $all_rows[$key][$data['left_id']] = 0;
                }
                if (empty($all_rows[$key][$data['right_id']])) {
                    $all_rows[$key][$data['right_id']] = 0;
                }
                if (empty($all_rows[$key][$data['parent_id']])) {
                    $all_rows[$key][$data['parent_id']] = 0;
                }
                ...
                foreach ($right_stack as $k => $v) {
                    ...
                    if ($all_rows[$key][$data['right_id']] == $v) {
                        continue;
                    }
                    $temp_right = $v;
