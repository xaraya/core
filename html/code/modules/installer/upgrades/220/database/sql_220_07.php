...
function sql_220_07()
{
    ...
    try {
        ...
        while ($result->next()) {
            [$observer, $subject, $itemtype] = $result->fields;
            if (empty($itemtype)) {
                $itemtype = 0;
            }
        ...
        **/
        $fields = [
            'observer' => ['type' => 'integer', 'unsigned' => true, 'null' => false],
            'subject'  => ['type' => 'integer', 'unsigned' => true, 'null' => false],
            'itemtype' => ['type' => 'integer', 'unsigned' => true, 'null' => false],
        ...
        $index = [
            ...
            'fields' => ['observer', 'subject', 'itemtype', 'scope'],
            'unique' => true,
        ];
