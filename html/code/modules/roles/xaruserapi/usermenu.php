...
function roles_userapi_usermenu($args)
{
    ...
    if (!xarUserIsLoggedIn()){
        ...
        xarController::$response->redirect(xarModURL($defaultloginmodname,'user','showloginform', array('redirecturl' => $redirecturl)));
    }
    ...
    switch (strtolower($phase)) {
        ...
        **/
        case 'updateitem':
            ...
            return xarController::$response->redirect($returnurl);
            */
