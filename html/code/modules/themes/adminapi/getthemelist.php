...
/**
 * themes adminapi getthemelist function
 * @extends MethodClass<AdminApi>
 */
class GetthemelistMethod extends MethodClass
{
    ...
    public function __invoke(array $args = [])
    {
        ...
        static $validOrderFields = ['name' => 'themes', 'regid' => 'themes',
            'class' => 'infos'];
        if (!isset($filter)) {
            $filter = [];
        }
