 ...
 */
class MixedFieldType extends ScalarType
{
    ...
    {
        //$context->tracePath(__CLASS__ . '::serialize: ' . gettype($value));
        return $value;
    }
    ...
    {
        //$context->tracePath(__CLASS__ . '::parseValue: ' . gettype($value));
        return $value;
    }
    ...
    {
        //$context->tracePath(__CLASS__ . '::parseLiteral: ' . $valueNode->kind, $variables);
