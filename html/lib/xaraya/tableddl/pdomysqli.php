...
/**
 * Table Maintenance API for MySQL - PDO
 * @deprecated 2.4.1 use MysqliDDL instead
 *
 * @package core
 * @subpackage database
    ...
    public static function alterTable($tableName, $args)
    {
        switch ($args['command']) {
            case 'add':
                ...
                // TODO: adapt static::columnDefinition to return field name too
                ...
                //$sql .= join(' ', static::columnDefinition($args['field'], $args));
