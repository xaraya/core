...
{
    public static function _nonVisitedInDegree(GraphNode $node);
    public static function _sort(Graph $graph);
    public static function sort(Graph $graph);
}
interface IAcyclicTest
{
    public static function _nonVisitedInDegree(GraphNode $node);
    public static function _isAcyclic(&$graph);
    public static function isAcyclic(Graph $graph);
}

class GraphNode extends xarObject implements IGraphNode
{
    private $data = null;           // The data of this node
    private $metadata = [];    // The metadata of this node
    private $vertices = [];    // An array of references to the vertices this node is connected to
...
{
    /** @var array<GraphNode> */
    private $nodes = [];   // References to the nodes of this graph
