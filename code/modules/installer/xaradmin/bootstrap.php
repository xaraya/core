...
#
    ...
    if (!xarMod::apiFunc('modules', 'admin', 'standardinstall', array('module' => 'dynamicdata', 'objects' => $objects)))
        return;
# --------------------------------------------------------
...
//                   'modules_modvars',
    ...
    if (!xarMod::apiFunc('modules', 'admin', 'standardinstall', array('module' => 'modules', 'objects' => $objects)))
        return;
...
//                   'roles_roles',
    ...
    if (!xarMod::apiFunc('modules', 'admin', 'standardinstall', array('module' => 'roles', 'objects' => $objects)))
        return;
    ...
    if (!xarMod::apiFunc('modules', 'admin', 'standardinstall', array('module' => 'themes', 'objects' => $objects)))
        return;
    ...
    if (!xarMod::apiFunc('modules', 'admin', 'standardinstall', array('module' => 'categories', 'objects' => $objects)))
        return;
    ...
    if (!xarMod::apiFunc('modules', 'admin', 'standardinstall', array('module' => 'privileges', 'objects' => $objects)))
        return;
# --------------------------------------------------------
